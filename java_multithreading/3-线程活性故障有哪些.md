...
1. [Java 多线程编程（入门筑基）](https://github.com/leavesC/AndroidGuide/tree/gitbook/java_multithreading)
2. [Java 多线程编程（异步中包含同步）](https://github.com/leavesC/AndroidGuide/tree/gitbook/java_multithreading)
3. [Java 多线程编程（线程活性故障有哪些）](https://github.com/leavesC/AndroidGuide/tree/gitbook/java_multithreading)
4. [Java 多线程编程（“锁”事碎碎念）](https://github.com/leavesC/AndroidGuide/tree/gitbook/java_multithreading)
5. [Java 多线程编程（聊聊线程池）](https://github.com/leavesC/AndroidGuide/tree/gitbook/java_multithreading)
...
例如，对于上述的哲学家问题，假设某位哲学家比较有礼貌，当其拿起了左手边的筷子时，如果恰好有其他哲学家需要这根筷子，**有礼貌的哲学家**就主动放下筷子，让给其他哲学家使用。在最极端的情况下，每当有礼貌的哲学家一想要吃饭并拿起左手边的筷子时，就有其他哲学家需要这根筷子，此时有礼貌的哲学就会一直处于**拿起筷子-放下筷子-拿起筷子**这样一个循环过程中，导致一直无法吃饭。此时并没有发生死锁，但对于有礼貌的哲学家所代表的线程来说就是发生了活锁