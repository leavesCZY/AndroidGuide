...
* [Android 自定义View基础](https://github.com/leavesC/Java_Kotlin_Android_Learn)
...
* [Android 自定义View合辑，持续更新中](https://github.com/leavesC/CustomView)
    * [WaveLoadingView（贝塞尔曲线-2）](https://github.com/leavesC/CustomView)
...
* [Java 重拾](https://github.com/leavesC/Java_Kotlin_Android_Learn)
...
* [Java 集合框架](https://github.com/leavesC/Java_Kotlin_Android_Learn)
...
* [Kotlin 入门教程](https://github.com/leavesC/Java_Kotlin_Android_Learn)
    * [基础](kotlin)
	    * [变量、数据类型、函数](kotlin/1_变量、数据类型、函数.md)
        * [包、类型别名、修饰符](kotlin/2_Package、修饰符.md)
        * [数组、字符串模板](kotlin/3_数组、字符串模板.md)
        * [条件循环、区间、返回和跳转](kotlin/4_条件循环、区间、返回和跳转.md)
    * [类、接口、对象](kotlin)
        * [类的基本概念](kotlin/6_类的基本概念.md)
        * [抽象类、数据类、密封类、枚举类、匿名内部类、内部类、嵌套类](kotlin/7_抽象类、数据类、密封类、枚举类、匿名内部类、内部类、嵌套类.md)
        * [接口](kotlin/8_接口.md)
        * [继承](kotlin/9_继承.md)
    * [可空性](kotlin)
	    * [空安全](kotlin/10_空安全.md)
	    * [类型的检查与转换](kotlin/11_类型的检查与转换.md)
    * [集合](kotlin)
	    * [集合](kotlin/12_集合.md)
    * [函数和Lambda](kotlin)
        * [扩展函数和扩展属性](kotlin/13_扩展函数和扩展属性.md)
        * [命名参数、默认参数值、可变参数、局部函数](kotlin/14_命名参数、默认参数值、可变参数、局部函数.md)
        * [Lambda表达式](kotlin/15_Lambda表达式.md)
        * [with与apply函数](kotlin/16_with与apply函数.md)
        * [函数操作符](kotlin/17_函数操作符.md)
    * [其他](kotlin)
	    * [异常](kotlin/18_异常.md)
	    * [运算符重载](kotlin/19_运算符重载.md)
	    * [中缀调用、解构声明](kotlin/20_中缀调用、解构声明.md)
        * [对象表达式与对象声明](kotlin/21_对象表达式与对象声明.md)
        * [委托](kotlin/22_委托.md)
        * [注解](kotlin/24_注解.md)
