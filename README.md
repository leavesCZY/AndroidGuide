...
* [代码实践]()
  ...
  * [EventLiveData：对 Jetpack LiveData 进行功能扩展，解决黏性事件及通知延迟问题](https://github.com/leavesCZY/EventLiveData)
  * [KVHolder：一文读懂 SharedPreferences 的缺陷及一点点思考](https://github.com/leavesCZY/KVHolder)
  * [Monitor：OkHttp / Retrofit 抓包工具](https://github.com/leavesCZY/Monitor)
  * [JsonHolder：Java & Kotlin 的 Json 序列化和反序列化库](https://github.com/leavesCZY/JsonHolder)
  * [DoKV：一个小巧而强大的 Key-Value 管理框架](https://github.com/leavesCZY/DoKV)
  * [通过 Wifi Direct 在局域网下传输文件](https://github.com/leavesCZY/WifiP2P)
  * [通过 Wifi 热点在局域网下传输文件](https://github.com/leavesCZY/WifiFileTransfer)
  * [Android 6.0 运行时权限封装](https://github.com/leavesCZY/PermissionSteward)  
  * [linux 环境编译 ijkplayer so 库实践](https://github.com/leavesCZY/ijkplayer-so-extend)